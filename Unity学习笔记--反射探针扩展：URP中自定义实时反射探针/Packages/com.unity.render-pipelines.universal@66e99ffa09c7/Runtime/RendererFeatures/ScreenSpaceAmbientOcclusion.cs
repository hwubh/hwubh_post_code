...
namespace UnityEngine.Rendering.Universal
{
    ...
    public class ScreenSpaceAmbientOcclusion : ScriptableRendererFeature
    {
        ...
        public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
        {
            ...
            // 检查反射探针数据，如果未启用 SSAO，则跳过
            if(renderingData.frameData.Contains<UniversalReflectionProbeData>())
            {
                var probeData = renderingData.frameData.Get<UniversalReflectionProbeData>().probeData;
                if (probeData != null && !probeData.SSAO)
                    return;
            }
