...
namespace UnityEngine.Rendering.Universal
{
    ...
    public sealed partial class UniversalRenderPipeline : RenderPipeline
    {
        ...
        internal static RenderTextureUVOriginStrategy renderTextureUVOriginStrategy { get; set; }
...
#pragma warning restore 618
        ...
        protected override void Render(ScriptableRenderContext renderContext, List<Camera> cameras)
        {
            ...
            using (new ContextRenderingScope(renderContext, cameras))
            {
                ...
                // 处理实时反射探针：仅在启用自定义实时探针时由 URP 驱动更新
                if (pipelineAsset != null && pipelineAsset.useCustomRealtimeReflectionProbe)
        ...
        internal static bool TryGetCullingParameters(UniversalCameraData cameraData, out ScriptableCullingParameters cullingParams)
        {
...
#endif
                context.Submit(); // Actually execute the commands that we previously sent to the ScriptableRenderContext context, including the copy
            }
            CommandBufferPool.Release(cmd);
            ScriptableRenderer.current = null;
        }

        internal static void CreateShadowAtlasAndCullShadowCasters(UniversalLightData lightData, UniversalShadowData shadowData, UniversalCameraData cameraData, ref CullingResults cullResults, ref ScriptableRenderContext context)
        {
        ...
        internal static ScriptableRenderer GetRenderer(Camera camera, UniversalAdditionalCameraData additionalCameraData)
        {
        ...
        internal static UniversalCameraData CreateCameraData(ContextContainer frameData, Camera camera, UniversalAdditionalCameraData additionalCameraData)
        {
        ...
        internal static void InitializeAdditionalCameraData(Camera camera, UniversalAdditionalCameraData additionalCameraData, bool resolveFinalTarget, bool isLastBaseCamera, UniversalCameraData cameraData)
        {
        ...
        internal static UniversalRenderingData CreateRenderingData(ContextContainer frameData, UniversalRenderPipelineAsset settings, CommandBuffer cmd, RenderingMode? renderingMode, ScriptableRenderer renderer)
        {
        ...
        internal static UniversalShadowData CreateShadowData(ContextContainer frameData, UniversalRenderPipelineAsset urpAsset, RenderingMode? renderingMode)
        {
        ...
        internal static void ConfigureShadowDataForReflectionProbe(UniversalShadowData shadowData, UniversalAdditionalReflectionProbeData probeData)
        {
        ...
        internal static CullContextData CreateCullContextData(ContextContainer frameData, ScriptableRenderContext context)
        {
        ...
        internal static UniversalPostProcessingData CreatePostProcessingData(ContextContainer frameData, UniversalRenderPipelineAsset settings)
        {
        ...
        internal static UniversalResourceData CreateUniversalResourceData(ContextContainer frameData)
        {
            return frameData.Create<UniversalResourceData>();
        }

        internal static UniversalLightData CreateLightData(ContextContainer frameData, UniversalRenderPipelineAsset settings, NativeArray<VisibleLight> visibleLights, RenderingMode? renderingMode)
        {
        ...
        internal static void UpdateTemporalAATargets(UniversalCameraData cameraData)
        {
            if (cameraData.IsTemporalAAEnabled())
            {
        ...
        internal static void SetupPerCameraShaderConstants(CommandBuffer cmd)
        {
        ...
        internal static void CheckAndApplyDebugSettings(ref RenderingData renderingData)
        {
            var debugDisplaySettings = UniversalRenderPipelineDebugDisplaySettings.Instance;
...
#if ENABLE_ADAPTIVE_PERFORMANCE
        internal static void ApplyAdaptivePerformance(UniversalCameraData cameraData)
        {
            var noFrontToBackOpaqueFlags = SortingCriteria.SortingLayer | SortingCriteria.RenderQueue | SortingCriteria.OptimizeStateChanges | SortingCriteria.CanvasOrder;
        ...
        internal static void ApplyAdaptivePerformance(ContextContainer frameData)
        {
